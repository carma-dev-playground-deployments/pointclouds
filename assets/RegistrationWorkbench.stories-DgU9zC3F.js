import{j as t}from"./jsx-runtime-DNp_qQjF.js";import{r as b}from"./index-CSJjS6Ct.js";import{c as De,b as Ue,F as ve,d as pe,P as ce}from"./PointColorizer-Bl3Xt3WF.js";import{a as Te,S as Ve,P as $e}from"./StandalonePointCloudViewer-DOi5crTM.js";import{F as oe,e as He,g as ze,h as Ne,i as ke,j as Be}from"./DRACOLoader-DFzQRO_0.js";import{V as g,c as ue,Q as se,aq as Se,o as ge,R as We}from"./colorRamps-DtMNMcNc.js";import"./maplibre-gl-BDkdRVUS.js";import"./index-D1cknlJ6.js";import"./iframe-DhchKf-4.js";import"./OrbitControls-BzCzQKCA.js";import"./georadar-road-centerlines-BNbUUkYL.js";const Je=n=>({type:"Feature",id:n.id,geometry:null,properties:{title:n.label,carmaConf3D:{pointcloud:{format:n.format,url:`${Ue}/${n.artifactFileName}`,source:n.source,transform:n.transform,fields:n.fieldDimensions,hasRgb:n.hasRgb}},sourceTag:n.sourceTag,defaultDatum:n.defaultDatum}}),Ye={type:"FeatureCollection",features:De.map(Je)},Qe=15,Ge=.005,Ke=4,Xe=1e-4,ie=n=>new g(n.x,n.y,n.z),Ce={allowTranslation:{x:!0,y:!0,z:!0},allowRotation:{x:!0,y:!0,z:!0}};function Ze(n){if(n.length===0)return[];const s=n.reduce((w,p)=>w.add(ie(p)),new g).multiplyScalar(1/n.length),m=n.reduce((w,p)=>w+ie(p).distanceToSquared(s),0)/n.length*.0625;if(m<=Number.EPSILON)return n.map(()=>1);const c=-1/(2*m),o=n.map(w=>{const p=ie(w);let P=0;for(const _ of n)P+=Math.exp(c*p.distanceToSquared(ie(_)));return 1/P}),f=o.reduce((w,p)=>w+p,0)/o.length;return o.map(w=>w/f)}const et=n=>{const s=n.map(c=>[...c]),l=[[1,0,0],[0,1,0],[0,0,1]],m=[[0,1],[0,2],[1,2]];for(let c=0;c<32;c++){let o=0,f=1,w=0;for(const[x,k]of m)Math.abs(s[x][k])>w&&(w=Math.abs(s[x][k]),o=x,f=k);if(w<1e-14)break;const p=.5*Math.atan2(2*s[o][f],s[f][f]-s[o][o]),P=Math.cos(p),_=Math.sin(p);for(let x=0;x<3;x++){const k=s[x][o],F=s[x][f];s[x][o]=P*k-_*F,s[x][f]=_*k+P*F}for(let x=0;x<3;x++){const k=s[o][x],F=s[f][x];s[o][x]=P*k-_*F,s[f][x]=_*k+P*F}for(let x=0;x<3;x++){const k=l[x][o],F=l[x][f];l[x][o]=P*k-_*F,l[x][f]=_*k+P*F}}return{values:[s[0][0],s[1][1],s[2][2]],vectors:[new g(l[0][0],l[1][0],l[2][0]),new g(l[0][1],l[1][1],l[2][1]),new g(l[0][2],l[1][2],l[2][2])]}},tt=(n,s)=>{const l=s.length,m=n.map((c,o)=>[...c,s[o]]);for(let c=0;c<l;c++){let o=c;for(let f=c+1;f<l;f++)Math.abs(m[f][c])>Math.abs(m[o][c])&&(o=f);if(Math.abs(m[o][c])<1e-12)return null;[m[c],m[o]]=[m[o],m[c]];for(let f=0;f<l;f++){if(f===c)continue;const w=m[f][c]/m[c][c];for(let p=c;p<=l;p++)m[f][p]-=w*m[c][p]}}return m.map((c,o)=>c[l]/m[o][o])},Me=(n,s)=>{const l=2*Math.acos(ue.clamp(Math.abs(n.w),-1,1));return l<=s||l===0?n:new se().slerp(n,s/l)};function nt(n,s={}){if(n.length<3)throw new Error("At least three point pairs are required");const l=n.map(e=>ie(e.source)),m=n.map(e=>ie(e.target)),c=(s.weighting??"density")==="density"?Ze(l):l.map(()=>1),o=c.reduce((e,r)=>e+r,0),f=l.reduce((e,r,i)=>e.addScaledVector(r,c[i]),new g).multiplyScalar(1/o),w=m.reduce((e,r,i)=>e.addScaledVector(r,c[i]),new g).multiplyScalar(1/o),p={...Ce.allowRotation,...s.allowRotation},P=p.x||p.y||p.z,_=ue.degToRad(Math.max(0,s.maxRotationDegrees??Qe)),x=Math.max(0,s.maxUniformScaleDeviation??Ge),k=s.minUniformScale??1-x,F=s.maxUniformScale??1+x,$=[1,Math.max(Number.EPSILON,s.verticalErrorWeight??Ke),1],y=new Float64Array(9);for(let e=0;e<n.length;e++){const r=c[e],i=l[e].clone().sub(f),d=m[e].clone().sub(w);y[0]+=r*d.x*i.x,y[1]+=r*d.x*i.y,y[2]+=r*d.x*i.z,y[3]+=r*d.y*i.x,y[4]+=r*d.y*i.y,y[5]+=r*d.y*i.z,y[6]+=r*d.z*i.x,y[7]+=r*d.z*i.y,y[8]+=r*d.z*i.z}const he=y[0]+y[4]+y[8],le=y[7]-y[5],K=y[2]-y[6],A=y[3]-y[1],ee=y[0]-y[4]-y[8],Y=y[3]+y[1],I=y[2]+y[6],te=-y[0]+y[4]-y[8],re=y[7]+y[5],me=-y[0]-y[4]+y[8],H=[[he,le,K,A],[le,ee,Y,I],[K,Y,te,re],[A,I,re,me]],fe=Math.max(...H.map(e=>e.reduce((r,i)=>r+Math.abs(i),0))),Q=H.map((e,r)=>e.map((i,d)=>r===d?i+fe:i));let D=[1,.5,.25,.125];for(let e=0;e<128;e++){const r=Q.map(d=>d.reduce((M,h,j)=>M+h*D[j],0)),i=Math.hypot(...r);D=r.map(d=>d/(i||1))}let S=P?new se(D[1],D[2],D[3],D[0]).normalize():new se;if(!(p.x&&p.y&&p.z)){const e=new Se().setFromQuaternion(S,"XYZ");e.x=p.x?e.x:0,e.y=p.y?e.y:0,e.z=p.z?e.z:0,S=new se().setFromEuler(e)}S=Me(S,_);let z=1;if(s.allowUniformScale){let e=0,r=0;for(let i=0;i<l.length;i++){const d=c[i],M=l[i].clone().sub(f),h=m[i].clone().sub(w);e+=d*h.dot(M.applyQuaternion(S)),r+=d*M.lengthSq()}z=r>Number.EPSILON?e/r:1,z=ue.clamp(z,k,F)}let v=w.clone().sub(f.clone().applyQuaternion(S).multiplyScalar(z));const C=[];if(P){const e=[[0,0,0],[0,0,0],[0,0,0]],r=[new g(1,0,0),new g(0,1,0),new g(0,0,1)];for(let j=0;j<l.length;j++){const O=l[j].clone().sub(f).applyQuaternion(S).multiplyScalar(z),U=r.map(N=>N.clone().cross(O));for(let N=0;N<3;N++)for(let E=N;E<3;E++){let R=0;R+=$[0]*U[N].x*U[E].x,R+=$[1]*U[N].y*U[E].y,R+=$[2]*U[N].z*U[E].z,e[N][E]+=c[j]*R,N!==E&&(e[E][N]=e[N][E])}}if(!p.x){e[0]=[0,0,0];for(const j of e)j[0]=0}if(!p.y){e[1]=[0,0,0];for(const j of e)j[1]=0}if(!p.z){e[2]=[0,0,0];for(const j of e)j[2]=0}const{values:i,vectors:d}=et(e),M=Math.max(...i,0);for(let j=0;j<3;j++)i[j]>M*Xe&&C.push(d[j]);const h=2*Math.acos(ue.clamp(Math.abs(S.w),-1,1));if(h>1e-9&&C.length<3){const O=new g(S.x,S.y,S.z).multiplyScalar(Math.sign(S.w)||1).normalize().multiplyScalar(h),U=C.reduce((E,R)=>E.addScaledVector(R,O.dot(R)),new g),N=U.length();S=N>1e-12?new se().setFromAxisAngle(U.clone().normalize(),N):new se}}const q=!!s.allowUniformScale,T=C.length+3+(q?1:0);for(let e=0;e<20;e++){const r=Array.from({length:T},()=>new Array(T).fill(0)),i=new Array(T).fill(0),d=new Array(T);for(let h=0;h<l.length;h++){const j=l[h].clone().applyQuaternion(S),O=j.clone().multiplyScalar(z),U=O.clone().add(v),N=m[h].clone().sub(U);for(let R=0;R<C.length;R++)d[R]=C[R].clone().cross(O);d[C.length]=new g(1,0,0),d[C.length+1]=new g(0,1,0),d[C.length+2]=new g(0,0,1),q&&(d[C.length+3]=j);const E=c[h];for(let R=0;R<T;R++){const Z=d[R];i[R]+=E*($[0]*Z.x*N.x+$[1]*Z.y*N.y+$[2]*Z.z*N.z);for(let W=R;W<T;W++){const a=d[W],u=E*($[0]*Z.x*a.x+$[1]*Z.y*a.y+$[2]*Z.z*a.z);r[R][W]+=u,R!==W&&(r[W][R]=r[R][W])}}}for(let h=0;h<T;h++)r[h][h]+=1e-12+r[h][h]*1e-9;const M=tt(r,i);if(!M)break;if(C.length>0){const h=C.reduce((O,U,N)=>O.addScaledVector(U,M[N]),new g),j=h.length();j>1e-15&&(S=new se().setFromAxisAngle(h.clone().normalize(),j).multiply(S),S=Me(S,_))}if(v.x+=M[C.length],v.y+=M[C.length+1],v.z+=M[C.length+2],q&&(z=ue.clamp(z+M[C.length+3],k,F)),Math.max(...M.map(h=>Math.abs(h)))<1e-12)break}const L=new Se().setFromQuaternion(S,"XYZ");L.x=p.x?L.x:0,L.y=p.y?L.y:0,L.z=p.z?L.z:0;const V=Me(new se().setFromEuler(L),_),ae=new Se().setFromQuaternion(V,"XYZ");v=new g;for(let e=0;e<l.length;e++){const r=l[e].clone().applyQuaternion(V).multiplyScalar(z);v.addScaledVector(m[e].clone().sub(r),c[e])}v.multiplyScalar(1/o);const X={...Ce.allowTranslation,...s.allowTranslation};if(X.x||(v.x=0),X.y||(v.y=0),X.z||(v.z=0),s.maxTranslationMeters!==void 0){const e=Math.max(0,s.maxTranslationMeters);v.clampLength(0,e)}const ne=new ge().compose(v,V,new g(z,z,z)),B=n.map(e=>ie(e.target).distanceTo(ie(e.source).applyMatrix4(ne))),ye=B.reduce((e,r)=>e+r*r,0);return{matrix:ne,translation:v,rotation:ae,residuals:B,rmsResidualMeters:Math.sqrt(ye/B.length),maximumResidualMeters:Math.max(...B),uniformScale:z,weights:c}}const Pe=n=>`[${n.x.toFixed(3)}, ${n.y.toFixed(3)}, ${n.z.toFixed(3)}]`;function rt({pair:n,anchor:s,onChange:l}){const m=b.useRef(null),c=w=>{var F;const p=(F=m.current)==null?void 0:F.getBoundingClientRect();if(!p)return;const P=ue.clamp((w.clientX-p.left)/p.width*4-2,-2,2),_=ue.clamp(2-(w.clientY-p.top)/p.height*4,-2,2),x=Math.hypot(P,_),k=x>2?2/x:1;l(P*k,_*k)},o=n.target.x-s.east,f=-n.target.z-s.north;return t.jsxs("div",{ref:m,className:"mesh-xy-pad",role:"slider","aria-label":"Mesh relative East North adjustment",onPointerDown:w=>{w.currentTarget.setPointerCapture(w.pointerId),c(w)},onPointerMove:w=>{w.currentTarget.hasPointerCapture(w.pointerId)&&c(w)},children:[t.jsx("span",{className:"mesh-xy-pad-axis mesh-xy-pad-axis-x"}),t.jsx("span",{className:"mesh-xy-pad-axis mesh-xy-pad-axis-y"}),t.jsx("span",{className:"mesh-xy-pad-point",style:{left:`${50+o*25}%`,top:`${50-f*25}%`}}),t.jsx("span",{className:"mesh-xy-pad-label mesh-xy-pad-label-x",children:"+E"}),t.jsx("span",{className:"mesh-xy-pad-label mesh-xy-pad-label-y",children:"+N"})]})}function at({pair:n,xyAnchor:s,zAnchor:l,onXYChange:m,onZChange:c,onZStart:o}){return t.jsxs("div",{className:"mesh-point-adjustment",children:[t.jsxs("div",{className:"mesh-point-delta","aria-live":"polite",children:["ΔE ",(n.target.x-s.east).toFixed(2)," m · ΔN ",(-n.target.z-s.north).toFixed(2)," m · ΔU ",(n.target.y-l).toFixed(2)," m"]}),t.jsxs("div",{className:"mesh-point-inputs",children:[t.jsx("div",{title:"Mesh relative East/North adjustment, maximum radius 2 meters",children:t.jsx(rt,{pair:n,anchor:s,onChange:m})}),t.jsx("input",{type:"range",min:"-10",max:"10",step:"0.01",className:"mesh-z-adjustment","aria-label":"Mesh relative Up adjustment",title:"Mesh relative Up adjustment",value:n.target.y-l,onFocus:o,onChange:f=>c(Number(f.target.value))})]})]})}function Ie({pairs:n,onRemoveLastPair:s,onClear:l,onSolved:m,onSelectPair:c,selectedPairIndex:o,onUpdatePair:f,onRemovePair:w,onAddPointPair:p,onImportPairs:P,onLoadPreset:_,datasetPresets:x,activeDatasetId:k,onSelectDataset:F,meshLoadState:de,onFramePointCloud:$,onMaximizeCurrentView:y,onFrameMesh:he,onFrameRegistrationPairs:le,onFrameRegistrationPair:K,pointStyle:A,onPointStyleChange:ee,onOpenFieldColorizer:Y,meshInspectionPreview:I,onMeshInspectionPreviewChange:te,meshErrorTarget:re,onMeshErrorTargetChange:me}){const[H,fe]=b.useState(!0),[Q,D]=b.useState(!0),[S,z]=b.useState(100),[v,C]=b.useState(null),[q,T]=b.useState(!1),L=b.useRef(new Map),V=b.useRef(new Map),ae=b.useMemo(()=>n.map(({source:e,target:r})=>`${e.x},${e.y},${e.z}|${r.x},${r.y},${r.z}`).join(";"),[n]),X=b.useMemo(()=>({allowRotation:{x:H,y:H,z:H},allowTranslation:{x:!0,y:!0,z:!0},maxTranslationMeters:S,allowUniformScale:Q}),[H,S,Q]),ne=()=>{if(n.length<3)return;const e=nt(n,X);C(e),m==null||m(e)};b.useEffect(()=>{n.length>=3?ne():C(null)},[ae,X]);const B=()=>{const e={format:"carma-mesh-registration-v1",pairs:n.map(({source:M,target:h})=>({source:[M.x,M.y,M.z],target:[h.x,h.y,h.z]})),constraints:{allowRotation:H,allowVerticalTranslation:!0,maxTranslation:S,allowUniformScale:Q}},r=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),i=URL.createObjectURL(r),d=document.createElement("a");d.href=i,d.download="mesh-registration.json",d.click(),URL.revokeObjectURL(i)},ye=async e=>{try{const r=JSON.parse(await e.text());if(r.format!=="carma-mesh-registration-v1"||!Array.isArray(r.pairs))throw new Error("Unsupported registration file");const i=r.pairs.map(({source:d,target:M})=>{if(![d,M].every(h=>Array.isArray(h)&&h.length===3&&h.every(Number.isFinite)))throw new Error("Invalid registration pair");return{source:new g(...d),target:new g(...M)}});P==null||P(i)}catch(r){window.alert(r instanceof Error?r.message:"Invalid registration file")}};return t.jsxs(t.Fragment,{children:[t.jsx(ve,{title:"Mesh registration",onClose:()=>{},showClose:!1,className:"registration-modal",initial:{x:12,y:12},zIndex:20,headerActions:t.jsx("button",{className:"info-action",type:"button",onClick:()=>T(e=>!e),title:"Registration info","aria-label":"Registration info",children:t.jsx(oe,{icon:He})}),children:t.jsxs("aside",{className:"pointcloud-registration-panel","aria-label":"Registration",children:[q&&t.jsxs("div",{className:"registration-info",children:[t.jsxs("p",{children:["Click a point on the point cloud, then the corresponding point on the mesh. The solver moves point-cloud coordinates into Mesh 2024 coordinates. Pair ",n.length," of at least 3 is currently selected."]}),t.jsxs("div",{className:"pointcloud-registration-status",children:["Mesh 2024: ",de==="loaded"?"loaded":de==="error"?"error":"loading…"]})]}),x&&x.length>0&&F&&t.jsxs("label",{className:"registration-dataset-picker",children:["Dataset",t.jsx("select",{value:k,onChange:e=>F(e.target.value),children:x.map(e=>t.jsx("option",{value:e.id,children:e.label},e.id))})]}),t.jsxs("fieldset",{className:"pointcloud-style-fieldset",children:[t.jsx("legend",{children:"Point cloud style"}),t.jsxs("label",{children:["Size mode",t.jsx("span",{className:"pointcloud-style-buttons",children:[[pe.AUTO,"Auto"],[pe.PIXELS,"Pixels"],[pe.METERS,"Meters"]].map(([e,r])=>t.jsx("button",{type:"button",className:A.sizeMode===e?"is-active":"",onClick:()=>ee({...A,sizeMode:e}),children:r},e))})]}),A.sizeMode===pe.PIXELS&&t.jsxs("label",{className:"inline-range-label",children:["Point size ",t.jsx("input",{type:"range",min:"0.5",max:"8",step:"0.25",value:A.pointSize,onChange:e=>ee({...A,pointSize:Number(e.target.value)})}),t.jsxs("output",{children:[A.pointSize.toFixed(2)," px"]})]}),A.sizeMode===pe.METERS&&t.jsxs("label",{className:"inline-range-label",children:["Radius ",t.jsx("input",{type:"range",min:"0.01",max:"2",step:"0.01",value:A.radiusMeters,onChange:e=>ee({...A,radiusMeters:Number(e.target.value)})}),t.jsxs("output",{children:[A.radiusMeters.toFixed(2)," m"]})]}),A.sizeMode===pe.AUTO&&t.jsxs("label",{className:"inline-range-label",children:["Radius scale ",t.jsx("input",{type:"range",min:"0.25",max:"4",step:"0.25",value:A.radiusScale,onChange:e=>ee({...A,radiusScale:Number(e.target.value)})}),t.jsxs("output",{children:["×",A.radiusScale.toFixed(2)]})]}),t.jsxs("label",{children:["Form",t.jsx("span",{className:"pointcloud-style-buttons",children:[[ce.SQUARE,"Square"],[ce.CIRCLE,"Circle"],[ce.DOME,"Dome"],[ce.SOFT_SPLAT,"Gradient"]].map(([e,r])=>t.jsx("button",{type:"button",className:A.shape===e?"is-active":"",onClick:()=>ee({...A,shape:e}),children:r},e))})]}),Y&&t.jsx("div",{className:"pointcloud-style-buttons",children:t.jsx("button",{type:"button",onClick:Y,children:"Field colorizer…"})})]}),t.jsxs("div",{className:"mesh-appearance-controls",children:[t.jsxs("label",{children:["Quality",t.jsx("input",{type:"range",min:"0",max:"50",step:"0.5",value:re,onChange:e=>me(Number(e.target.value))}),t.jsx("output",{children:re.toFixed(1)})]}),t.jsxs("label",{children:["Opacity",t.jsx("input",{type:"range",min:"0.1",max:"1",step:"0.05",value:I.opacity,onChange:e=>{const r=Number(e.target.value);te({...I,enabled:r<1||I.wireframe,opacity:r})}}),t.jsxs("output",{children:[Math.round(I.opacity*100),"%"]})]}),t.jsx("button",{type:"button",className:I.wireframe?"is-active":"",onClick:()=>{const e=!I.wireframe;te({...I,enabled:e||I.opacity<1,wireframe:e})},children:"Wireframe"})]}),t.jsxs("div",{className:"pointcloud-registration-actions pointcloud-registration-view-actions",children:[t.jsx("button",{type:"button",onClick:$,children:"Fly to point cloud"}),t.jsx("button",{type:"button",onClick:y,children:"Maximize current view"}),t.jsx("button",{type:"button",disabled:de!=="loaded",onClick:he,children:"Fly to mesh"}),t.jsx("button",{type:"button",disabled:n.length===0,onClick:le,children:"Fly to pairs"})]}),t.jsxs("div",{className:"registration-constraints",children:[t.jsxs("label",{children:[t.jsx("input",{type:"checkbox",checked:H,onChange:e=>fe(e.target.checked)})," Rotation"]}),t.jsxs("label",{children:[t.jsx("input",{type:"checkbox",checked:Q,onChange:e=>D(e.target.checked)})," Scale"]})]}),t.jsxs("div",{className:"pointcloud-registration-actions",children:[t.jsx("button",{type:"button",disabled:n.length<3,onClick:ne,children:"Solve"}),t.jsx("button",{type:"button",disabled:n.length===0,onClick:B,children:"Export JSON"}),t.jsxs("label",{className:"pointcloud-registration-file-button",children:["Import JSON",t.jsx("input",{type:"file",accept:"application/json,.json",hidden:!0,onChange:e=>{var i;const r=(i=e.target.files)==null?void 0:i[0];r&&ye(r),e.target.value=""}})]}),_&&t.jsx("button",{type:"button",onClick:_,children:"Nordbahn preset"})]})]})}),t.jsx(ve,{title:`Point pairs (${n.length})`,onClose:()=>{},showClose:!1,className:"point-pairs-modal",headerActions:t.jsxs("span",{className:"pair-header-actions",children:[t.jsx("button",{type:"button",disabled:n.length===0,onClick:le,title:"Fly to all pairs","aria-label":"Fly to all pairs",children:t.jsx(oe,{icon:ze})}),t.jsx("button",{type:"button",disabled:o===null||o<=0,onClick:()=>{if(o!==null){const e=o-1;c(e),K(e)}},title:"Previous pair","aria-label":"Previous pair",children:t.jsx(oe,{icon:Ne})}),t.jsx("button",{type:"button",disabled:o===null||o>=n.length-1,onClick:()=>{if(o!==null){const e=o+1;c(e),K(e)}},title:"Next pair","aria-label":"Next pair",children:t.jsx(oe,{icon:ke})})]}),initial:{x:430,y:12},zIndex:21,children:t.jsxs("aside",{className:"pointcloud-registration-panel pointcloud-pair-list-panel","aria-label":"Point pairs",children:[t.jsxs("div",{className:"pointcloud-registration-actions",children:[t.jsx("button",{type:"button",onClick:p,children:"Add point pair"}),t.jsx("button",{type:"button",disabled:n.length===0,onClick:s,children:"Remove last"}),t.jsx("button",{type:"button",disabled:n.length===0,onClick:l,children:"Clear"})]}),t.jsx("ol",{children:n.map((e,r)=>{var i,d;return t.jsxs("li",{className:"pointcloud-registration-pair",children:[t.jsxs("button",{className:`pair-summary-button${o===r?" is-selected":""}`,type:"button",onClick:()=>c(r),title:"Adjust pair",children:[t.jsxs("span",{children:["Pair ",r+1]}),t.jsx("code",{children:Pe(new g(e.source.x,e.source.y,e.source.z))})]}),t.jsxs("span",{className:"pair-target-summary",title:"Mesh point",children:["→ ",Pe(new g(e.target.x,e.target.y,e.target.z))]}),t.jsxs("span",{className:"pair-delta-summary",title:"Mesh adjustment delta",children:["Δ ",(e.target.x-(((i=V.current.get(r))==null?void 0:i.east)??e.target.x)).toFixed(2),", ",(-e.target.z-(((d=V.current.get(r))==null?void 0:d.north)??-e.target.z)).toFixed(2),", ",(e.target.y-(L.current.get(r)??e.target.y)).toFixed(2)," m"]}),v&&Number.isFinite(v.residuals[r])&&t.jsxs("small",{className:`pair-error${v.residuals[r]===v.maximumResidualMeters?" is-worst":""}`,title:"Pair residual",children:[v.residuals[r].toFixed(3)," m"]}),t.jsx("button",{className:"icon-action",type:"button",onClick:()=>K(r),title:"Fly to pair","aria-label":"Fly to pair",children:t.jsx(oe,{icon:ze})}),t.jsx("button",{className:"icon-action icon-action-danger",type:"button",onClick:()=>w(r),title:"Delete pair","aria-label":"Delete pair",children:t.jsx(oe,{icon:Be})})]},r)})}),v&&t.jsxs("output",{className:"registration-result",children:["RMS residual: ",v.rmsResidualMeters.toFixed(3)," m; maximum: "," ",v.maximumResidualMeters.toFixed(3)," m",Q&&`; scale: ${v.uniformScale.toFixed(5)}×`,t.jsx("div",{className:"matrix-readout","aria-label":"Solved transformation matrix",children:Array.from({length:4},(e,r)=>t.jsx("div",{children:Array.from({length:4},(i,d)=>v.matrix.elements[d*4+r].toFixed(5)).join("  ")},r))})]})]})}),o!==null&&n[o]&&t.jsx(ve,{title:`Adjust pair ${o+1}`,onClose:()=>{},showClose:!1,className:"point-adjustment-modal",transparent:!0,headerActions:t.jsxs("span",{className:"pair-header-actions",children:[t.jsx("button",{type:"button",disabled:o<=0,onClick:()=>{const e=o-1;c(e),K(e)},title:"Previous pair","aria-label":"Previous pair",children:t.jsx(oe,{icon:Ne})}),t.jsx("button",{type:"button",disabled:o>=n.length-1,onClick:()=>{const e=o+1;c(e),K(e)},title:"Next pair","aria-label":"Next pair",children:t.jsx(oe,{icon:ke})})]}),initial:{x:430,y:360},zIndex:22,children:t.jsx("div",{className:"point-adjustment-modal-content",children:t.jsx(at,{pair:n[o],xyAnchor:V.current.get(o)??{east:n[o].target.x,north:-n[o].target.z},zAnchor:L.current.get(o)??n[o].target.y,onXYChange:(e,r)=>{const i=o,d=n[i],M=V.current.get(i)??{east:d.target.x,north:-d.target.z};V.current.set(i,M),f(i,{source:d.source,target:new g(M.east+e,d.target.y,-(M.north+r))})},onZStart:()=>L.current.set(o,n[o].target.y),onZChange:e=>{const r=o,i=n[r],d=L.current.get(r)??i.target.y;f(r,{source:i.source,target:new g(i.target.x,d+e,i.target.z)})}})})})]})}Ie.__docgenInfo={description:"",methods:[],displayName:"RegistrationWorkbench",props:{pairs:{required:!0,tsType:{name:"unknown"},description:""},onRemoveLastPair:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},onClear:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},onSolved:{required:!1,tsType:{name:"signature",type:"function",raw:"(result: RigidRegistrationResult) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
...
}`,...(Le=(Fe=xe.parameters)==null?void 0:Fe.docs)==null?void 0:Le.source}}};const vt=["Workbench"];export{xe as Workbench,vt as __namedExportsOrder,St as default};
